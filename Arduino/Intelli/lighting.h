...
#define MAX_LIGHT 130 //Maximum light level we shall considered "on"
#define HALF_LIGHT 10 //This level which represents our "dawn" mode.
#define MIN_LIGHT 5 //The level we which shall go down to before shutting of completely
#define FADE_TIME 20 //Ms of the time in steps to fade up or down
